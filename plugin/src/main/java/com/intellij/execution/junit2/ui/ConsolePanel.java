...
public class ConsolePanel extends TestResultsPanel
{
	...
	public ConsolePanel(final JComponent console, final TestsOutputConsolePrinter printer, final JUnitConsoleProperties properties, AnAction[] consoleActions)
	{
	...
	private static class StartingProgress implements Runnable
	{
		...
		public StartingProgress(final Tree tree)
		{
			...
			myTree.setCellRenderer(new TreeCellRenderer()
			{
				@NotNull
				@Override
				public Component getTreeCellRendererComponent(@NotNull final JTree tree,
						final Object value,
