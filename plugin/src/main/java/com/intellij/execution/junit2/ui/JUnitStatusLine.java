...
class JUnitStatusLine extends TestStatusLine
{
	...
	private static class StateInfo
	{
		...
		private String generateTermMessage(final String testCount)
		{
			...
			{
				case DONE:
					return ExecutionBundle.message("junit.running.info.status.done.count", testCount);
				default:
					return ExecutionBundle.message("junit.running.info.status.terminated.count", testCount);
			}
		}
