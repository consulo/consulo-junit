...
public class TestProxy extends AbstractTestProxy
{
	...
	public Location getLocation(@NotNull final Project project, @NotNull GlobalSearchScope searchScope)
	{
		...
		else
		{
			...
			{
				return new PsiMemberParameterizedLocation(project, location.getPsiElement(), location instanceof MethodLocation ? ((MethodLocation) location).getContainingClass() : null,
